...
VIAddVersionKey ProductName "${LONGNAME}"
...
VIAddVersionKey FileDescription "${LONGNAME}"
...
Section "Main"
	...
	WarnAnotherInstance:
		MessageBox MB_OK|MB_ICONINFORMATION `Another instance of ${APP} is already running.  Please close other instances of ${APP} before launching ${LONGNAME}.`
		Abort
